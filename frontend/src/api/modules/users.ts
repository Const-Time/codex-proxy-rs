...
export const updateUser = (data: { id: string, username?: string, quotaMultipliers?: Record<string, string>, enabled: boolean, groupIds: string[], maxConcurrency: number, requestsPerMinute: number }) => request<User>({ url: '/api/admin/users/update', method: 'POST', data })
