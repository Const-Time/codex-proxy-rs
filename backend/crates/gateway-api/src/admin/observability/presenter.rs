...
pub(crate) fn usage_list_record_view(record: domain::UsageListRecord) -> UsageListRecordView {
    ...
    UsageListRecordView {
        ...
        turn_state_source: record.turn_state_source,
...
pub(crate) fn trend_point_view(point: domain::TrendPoint) -> TrendPointView {
    ...
    TrendPointView {
        ...
        cache_write_tokens: format_compact_number(point.metrics.cache_write_tokens),
        cache_write_tokens_value: point.metrics.cache_write_tokens,
...
pub(crate) fn usage_insights_view(insights: domain::UsageInsights) -> UsageInsightsOverviewView {
    ...
    UsageInsightsOverviewView {
        ...
        cost: OverviewCostView {
            ...
            cache_write_tokens: insights.cost.cache_write_tokens,
